...
class Schedule extends CI_Controller {
    ...
    public function get_planned_batches() {
        ...
        $this->curl->create('https://production-planner.herokuapp.com/api/v1/batch_plans/get_planned_batches');
...
//        die();
    ...
    public function generate_schedule() {
        ...
        $url = 'https://production-planner.herokuapp.com/api/v1/schedules/generate_schedule';
//        $url = '172.16.0.22:1313/api/v1/schedules/generate_schedule';
    ...
    public function batch_number() {
        ...
        $url = 'https://production-planner.herokuapp.com/api/v1/batches/' . $uuid . '/set_batch_number';
    ...
    public function publish_schedule() {
        $url = 'https://production-planner.herokuapp.com/api/v1/schedules/publish_schedule';
        $responce = $this->postCURL($url, array());
        echo $responce;
    }

    public function unpublish_schedule() {
        $url = 'https://production-planner.herokuapp.com/api/v1/schedules/unpublish_schedule';
        $responce = $this->postCURL($url, array());
        echo $responce;
    }
...
//        echo '<pre>';print_r($date);die();
        ...
        $url = 'https://production-planner.herokuapp.com/api/v1/schedules/get_schedule';
        if (isset($date))
    ...
    public function set_actual_time() {
        ...
        $url = 'https://production-planner.herokuapp.com/api/v1/schedules/' . $uuid . '/set_actual_time';
