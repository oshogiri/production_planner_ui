...
<div class="content">
    ...
    <div class="page-title-wrapper">
        <h2 class="page-title">Demand Sheet</h2>
    ...
    <div class="panel panel-default-light border-default">
        <div class="panel-heading">
            ...
            <div class="panel-tools">
                <a href="<?php echo base_url() . 'sample/DemandSheet.xlsx' ?>" class="btn btn-info btn-sm" download>
                    <span>
                        <i class="fa fa-download"></i>
                        Download Sample Demand Sheet File
                    </span>
                </a>
            </div>
        </div><!-- /.panel-heading -->
        ...
        <div class="panel-body">
            ...
            <?php } ?> 
            <?php echo form_open_multipart('DemandSheet/upload_demand_sheet'); ?>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            <td>
                                <form method="post" action="<?php echo site_url('DemandSheet/upload_demand_sheet') ?>" enctype="multipart/form-data">
